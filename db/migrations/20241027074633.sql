...
INSERT INTO `new_token` (`id`, `accessToken`, `accessExpiration`, `refreshToken`, `refreshExpiration`) SELECT `id`, `accessToken`, `accessTokenExpiration`, `refreshToken`, `refreshTokenExpiration` FROM `token`;
